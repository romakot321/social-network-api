...
class CreatorCreateDTO(BaseModel):
    ...
    def as_form(
        cls,
        name: str = Form(),
        youtube_username: str | None = Form(None),
        tiktok_username: str | None = Form(None),
        instagram_username: str | None = Form(None),
        fotobudka_url: str | None = Form(None),
    ):
        return cls(
            name=name,
